...
### [18] [Improving Code Translation with Syntax-Guided and Semantic-aware Preference Optimization](https://arxiv.org/abs/2605.13229)
...
### [25] [A Constraint Programming Approach for $n$-Day Lookahead Playoff Clinching](https://arxiv.org/abs/2605.13142)
...
### [58] [BackFlush: Knowledge-Free Backdoor Detection and Elimination with Watermark Preservation in Large Language Models](https://arxiv.org/abs/2605.12529)
...
### [59] [Ghost in the Context: Measuring Policy-Carriage Failures in Decision-Time Assembly](https://arxiv.org/abs/2605.12535)
*Igor Santos-Grueiro*
...
### [60] [Persona-Conditioned Adversarial Prompting (PCAP): Multi-Identity Red-Teaming for Enhanced Adversarial Prompt Discovery](https://arxiv.org/abs/2605.12565)
...
### [61] [Still Camouflage, Moving Illusion: View-Induced Trajectory Manipulation in Autonomous Driving](https://arxiv.org/abs/2605.12743)
...
### [62] [CoT-Guard: Small Models for Strong Monitoring](https://arxiv.org/abs/2605.12746)
...
### [63] [GraphIP-Bench: How Hard Is It to Steal a Graph Neural Network, and Can We Stop It?](https://arxiv.org/abs/2605.12827)
...
### [64] [HE-PIM: Demystifying Homomorphic Operations on a Real-world Processing-in-Memory System](https://arxiv.org/abs/2605.12841)
...
### [65] [Quantifying LLM Safety Degradation Under Repeated Attacks Using Survival Analysis](https://arxiv.org/abs/2605.12869)
*Zvi Topol*
...
### [66] [Do Skill Descriptions Tell the Truth? Detecting Undisclosed Security Behaviors in Code-Backed LLM Skills](https://arxiv.org/abs/2605.12875)
...
### [67] [ThermalTap: Passive Application Fingerprinting in VR Headsets via Thermal Side Channels](https://arxiv.org/abs/2605.12927)
...
### [68] [From Compression to Accountability: Harmless Copyright Protection for Dataset Distillation](https://arxiv.org/abs/2605.12942)
...
### [69] [CLOUDBURST: Cloud-Layer Observations Using Beacons for Unified Real-time Surveillance and Threat Attribution](https://arxiv.org/abs/2605.12976)
...
### [70] [Insecure Despite Proven Updated: Extracting the Root VCEK Seed on EPYC Milan via a Software-Only Attack](https://arxiv.org/abs/2605.12990)
*Muyan Shen,Yu Qin*
...
### [71] [No Attack Required: Semantic Fuzzing for Specification Violations in Agent Skills](https://arxiv.org/abs/2605.13044)
...
### [72] [Watermarking Should Be Treated as a Monitoring Primitive](https://arxiv.org/abs/2605.13095)
...
### [73] [Security Incentivization: An Empirical Study of how Micropayments Impact Code Security](https://arxiv.org/abs/2605.13100)
...
### [74] [DiffusionHijack: Supply-Chain PRNG Backdoor Attack on Diffusion Models and Quantum Random Number Defense](https://arxiv.org/abs/2605.13115)
...
### [75] [Automatic Detection of Reference Counting Bugs in Linux Kernel Drivers](https://arxiv.org/abs/2605.13246)
...
### [76] [Extending Blockchain Untraceability with Plausible Deniability](https://arxiv.org/abs/2605.13132)
...
### [77] [Empowering IoT Security: On-Device Intrusion Detection in Resource Constrained Devices](https://arxiv.org/abs/2605.13159)
...
### [78] [LoREnc: Low-Rank Encryption for Securing Foundation Models and LoRA Adapters](https://arxiv.org/abs/2605.13163)
...
### [79] [Backdoor Channels Hidden in Latent Space: Cryptographic Undetectability in Modern Neural Networks](https://arxiv.org/abs/2605.13214)
...
### [80] [Context-Aware Web Attack Detection in Open-Source SIEM Systems via MITRE ATT&CK-Enriched Behavioral Profiling](https://arxiv.org/abs/2605.13337)
...
### [81] [Inducing Overthink: Hierarchical Genetic Algorithm-based DoS Attack on Black-Box Large Language Reasoning Models](https://arxiv.org/abs/2605.13338)
...
### [82] [Model-Agnostic Lifelong LLM Safety via Externalized Attack-Defense Co-Evolution](https://arxiv.org/abs/2605.13411)
...
### [83] [Sleeper Channels and Provenance Gates: Persistent Prompt Injection in Always-on Autonomous AI Agents](https://arxiv.org/abs/2605.13471)
...
### [84] [Phantom Force: Injecting Adversarial Tactile Perceptions into Embodied Intelligence via EMI](https://arxiv.org/abs/2605.13492)
...
### [85] [Limits of Personalizing Differential Privacy Budgets](https://arxiv.org/abs/2605.13503)
...
### [86] [EBCC: Enclave-Backed Confidential Containers via OCI-Compatible Runtime Integration](https://arxiv.org/abs/2605.13676)
...
### [87] [MQTT Across a Raspberry Pi 5 IoT Network Utilizing Quantum-resistant Signature Algorithms](https://arxiv.org/abs/2605.13698)
...
### [88] [Identifying AI Web Scrapers Using Canary Tokens](https://arxiv.org/abs/2605.13706)
...
### [89] [DisAgg: Distributed Aggregators for Efficient Secure Aggregation in Federated Learning](https://arxiv.org/abs/2605.13708)
...
### [90] [VectorSmuggle: Steganographic Exfiltration in Embedding Stores and a Cryptographic Provenance Defense](https://arxiv.org/abs/2605.13764)
*Jascha Wanger*
...
### [91] [Stochastic Smoothed Particle Hydrodynamics for Stochastic Mechanics Problems](https://arxiv.org/abs/2605.12540)
...
### [92] [Robust Matrix-Free Newton-Krylov Solvers via Automatic Differentiation](https://arxiv.org/abs/2605.13378)
...
### [93] [Elastica++: A high-performance, multiphysics framework for large interacting assemblies of Cosserat rods](https://arxiv.org/abs/2605.13766)
...
### [94] [Chrono::Ray: A Distributed Framework for High-Throughput Simulation-Based Analysis of Multibody Systems](https://arxiv.org/abs/2605.13767)
...
### [95] [Emergency Vehicle Preemption Strategies using Machine Learning to Optimize Traffic Operations](https://arxiv.org/abs/2605.13814)
...
### [96] [Fine-Tuning Models for Automated Code Review Feedback](https://arxiv.org/abs/2605.12610)
...
### [97] [User Reviews as a Source for Usability Requirements: A Precursor Study on Using Large Language Models](https://arxiv.org/abs/2605.12657)
...
### [98] [Agentic Interpretation: Lattice-Structured Evidence for LLM-Based Program Analysis](https://arxiv.org/abs/2605.12694)
...
### [99] [Finding a Crab in the C: Assured Translation via Comparative Symbolic Execution](https://arxiv.org/abs/2605.12731)
...
### [100] [Project Life Cycles in Open-Source Software](https://arxiv.org/abs/2605.12738)
...
### [101] [AgentLens: Revealing The Lucky Pass Problem in SWE-Agent Evaluation](https://arxiv.org/abs/2605.12925)
...
### [102] [Protocol-Driven Development: Governing Generated Software Through Invariants and Evidence](https://arxiv.org/abs/2605.12981)
*Jun He,Deying Yu*
...
### [103] [Code-Centric Detection of Vulnerability-Fixing Commits: A Unified Benchmark and Empirical Study](https://arxiv.org/abs/2605.13138)
...
### [104] [SWE-Cycle: Benchmarking Code Agents across the Complete Issue Resolution Cycle](https://arxiv.org/abs/2605.13139)
...
### [105] [UIBenchKit: A unified toolkit for design-to-code model evaluation](https://arxiv.org/abs/2605.13141)
...
### [106] [ReproScore: Separating Readiness from Outcome in Research Software Reproducibility Assessment](https://arxiv.org/abs/2605.13275)
...
### [107] [Robust Mutation Analysis of Quantum Programs Under Noise](https://arxiv.org/abs/2605.13279)
...
### [108] [The Readability Spectrum: Patterns, Issues, and Prompt Effects in LLM-Generated Code](https://arxiv.org/abs/2605.13280)
...
### [109] [AI Harness Engineering: A Runtime Substrate for Foundation-Model Software Agents](https://arxiv.org/abs/2605.13357)
...
### [110] [SieveFL: Hierarchical Runtime-Aware Pruning for Scalable LLM-Based Fault Localization](https://arxiv.org/abs/2605.13491)
...
### [111] [Scalable Deductive Verification of Data-Level Parallel Programs](https://arxiv.org/abs/2605.13616)
...
### [112] [SkillOps: Managing LLM Agent Skill Libraries as Self-Maintaining Software Ecosystems](https://arxiv.org/abs/2605.13716)
...
### [113] [(How) Do Large Language Models Understand High-Level Message Sequence Charts?](https://arxiv.org/abs/2605.13773)
