...
### [11] [From Threat Intelligence to Firewall Rules: Semantic Relations in Hybrid AI Agent and Expert System Architectures](https://arxiv.org/abs/2603.03911)
...
### [12] [Generative AI in Managerial Decision-Making: Redefining Boundaries through Ambiguity Resolution and Sycophancy Analysis](https://arxiv.org/abs/2603.03970)
...
### [13] [A Dual-Helix Governance Approach Towards Reliable Agentic AI for WebGIS Development](https://arxiv.org/abs/2603.04390)
...
### [19] [Engineering a Governance-Aware AI Sandbox: Design, Implementation, and Lessons Learned](https://arxiv.org/abs/2603.03394)
...
### [20] [Review Beats Planning: Dual-Model Interaction Patterns for Code Synthesis](https://arxiv.org/abs/2603.03406)
*Jan Miller*
...
### [21] [Semantic Neighborhood Density and Eye Gaze Time in Human Programmer Attention](https://arxiv.org/abs/2603.03566)
...
### [22] [CONCUR: Benchmarking LLMs for Concurrent Code Generation](https://arxiv.org/abs/2603.03683)
...
### [23] [SWE-CI: Evaluating Agent Capabilities in Maintaining Codebases via Continuous Integration](https://arxiv.org/abs/2603.03823)
...
### [24] [Empirical Studies on Adversarial Reverse Engineering with Students](https://arxiv.org/abs/2603.03875)
...
### [25] [LoRA-MME: Multi-Model Ensemble of LoRA-Tuned Encoders for Code Comment Classification](https://arxiv.org/abs/2603.03959)
...
### [26] [CodeTaste: Can LLMs Generate Human-Level Code Refactorings?](https://arxiv.org/abs/2603.04177)
...
### [27] [Code Fingerprints: Disentangled Attribution of LLM-Generated Code](https://arxiv.org/abs/2603.04212)
...
### [28] [FeedAIde: Guiding App Users to Submit Rich Feedback Reports by Asking Context-Aware Follow-Up Questions](https://arxiv.org/abs/2603.04244)
...
### [29] [LikeThis! Empowering App Users to Submit UI Improvement Suggestions Instead of Complaints](https://arxiv.org/abs/2603.04245)
...
### [30] [Maude-HCS: Model Checking the Undetectability-Performance Tradeoffs of Hidden Communication Systems](https://arxiv.org/abs/2603.03369)
...
### [31] [Sleeper Cell: Injecting Latent Malice Temporal Backdoors into Tool-Using LLMs](https://arxiv.org/abs/2603.03371)
...
### [32] [Zero-Knowledge Federated Learning with Lattice-Based Hybrid Encryption for Quantum-Resilient Medical AI](https://arxiv.org/abs/2603.03398)
*Edouard Lansiaux*
...
### [33] [Sharing is caring: Attestable and Trusted Workflows out of Distrustful Components](https://arxiv.org/abs/2603.03403)
...
### [34] [On Google's SynthID-Text LLM Watermarking System: Theoretical Analysis and Empirical Validation](https://arxiv.org/abs/2603.03410)
...
### [35] [PRIVATEEDIT: A Privacy-Preserving Pipeline for Face-Centric Generative Image Editing](https://arxiv.org/abs/2603.03412)
...
### [36] [Zero-Knowledge Proof (ZKP) Authentication for Offline CBDC Payment System Using IoT Devices](https://arxiv.org/abs/2603.03804)
...
### [37] [Parallel Test-Time Scaling with Multi-Sequence Verifiers](https://arxiv.org/abs/2603.03417)
...
### [38] [Analyzing the Impact of Adversarial Attacks on C-V2X-Enabled Road Safety: An Age of Information Perspective](https://arxiv.org/abs/2603.03462)
...
### [39] [DKD-KAN: A Lightweight knowledge-distilled KAN intrusion detection framework, based on MLP and KAN](https://arxiv.org/abs/2603.03486)
*Mohammad Alikhani*
...
### [40] [Scrambler: Mixed Boolean Arithmetic Obfuscation Tool Using E-graph and Equality Expansion](https://arxiv.org/abs/2603.03624)
...
### [41] [Goal-Driven Risk Assessment for LLM-Powered Systems: A Healthcare Case Study](https://arxiv.org/abs/2603.03633)
...
### [42] [Reckless Designs and Broken Promises: Privacy Implications of Targeted Interactive Advertisements on Social Media Platforms](https://arxiv.org/abs/2603.03659)
...
### [43] [Internet malware propagation: Dynamics and control through SEIRV epidemic model with relapse and intervention](https://arxiv.org/abs/2603.03712)
...
### [44] [On the Suitability of LLM-Driven Agents for Dark Pattern Audits](https://arxiv.org/abs/2603.03881)
...
### [45] [Measuring Privacy vs. Fidelity in Synthetic Social Media Datasets](https://arxiv.org/abs/2603.03906)
...
### [46] [When Safety Becomes a Vulnerability: Exploiting LLM Alignment Homogeneity for Transferable Blocking in RAG](https://arxiv.org/abs/2603.03919)
...
### [47] [OMNIINTENT: A Trusted Intent-Centric Framework for User-Friendly Web3](https://arxiv.org/abs/2603.04168)
...
### [48] [CAM-LDS: Cyber Attack Manifestations for Automatic Interpretation of System Logs and Security Alerts](https://arxiv.org/abs/2603.04186)
...
### [49] [Statistical Effort Modelling of Game Resource Localisation Attacks](https://arxiv.org/abs/2603.04261)
...
### [50] [Hyper-reduction-free reduced-order Newton solvers for projection-based model-order reduction of nonlinear dynamical systems](https://arxiv.org/abs/2603.03420)
...
### [51] [FusionCut: Boundary Representation (B-Rep) Based and Cloud-Ready Cutter Workpiece Engagement (CWE) for Virtual Machining](https://arxiv.org/abs/2603.03504)
...
### [52] [STRIDE: Post-Training LLMs to Reason and Refine Bio-Sequences via Edit Trajectories](https://arxiv.org/abs/2603.03573)
