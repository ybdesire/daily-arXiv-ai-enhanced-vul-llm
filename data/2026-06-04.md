...
### [19] [From Prompt to Process: a Process Taxonomy and Comparative Assessment of Frameworks Supporting AI Software Development Agents](https://arxiv.org/abs/2606.04967)
...
### [20] [Plan First, Judge Later, Run Better: A DMAIC-Inspired Agentic System for Industrial Anomaly Detection](https://arxiv.org/abs/2606.04599)
...
### [21] [Toward Pre-Deployment Assurance for Enterprise AI Agents: Ontology-Grounded Simulation and Trust Certification](https://arxiv.org/abs/2606.04037)
...
### [22] [Stumbling Into AI Emotional Dependence: How Routine AI Interactions Reshape Human Connection](https://arxiv.org/abs/2606.04150)
...
### [23] [Thinking Through Signs: PEEL as a Semiotic Scaffolding for Epistemically Accountable AI-Enabled Research](https://arxiv.org/abs/2606.04152)
...
### [24] [SMAC-Talk: A Natural Language Extension of the StarCraft Multi-Agent Challenge for Large Language Models](https://arxiv.org/abs/2606.04202)
...
### [25] [Consensus is Strategically Insufficient: Reasoning-Trace Disagreement as a Knowledge-Representation Signal](https://arxiv.org/abs/2606.04223)
...
### [26] [VAMPS: Visual-Assisted Mathematical Problem Solving Benchmark](https://arxiv.org/abs/2606.04244)
...
### [27] [StepPRM-RTL: Stepwise Process-Reward Guided LLM Fine-Tuning for Enhanced RTL Synthesis](https://arxiv.org/abs/2606.04246)
...
### [28] [Can Generalist Agents Automate Data Curation?](https://arxiv.org/abs/2606.04261)
...
### [29] [Characterizing initial human-AI proof formalization workflows](https://arxiv.org/abs/2606.04273)
...
### [30] [The Saturation Trap and the Subjectivity of Intervention Timing: Why Affect-Based Triggers and LLM Judges Fail to Time Interventions on Autonomous Agents](https://arxiv.org/abs/2606.04296)
*Manvendra Modgil*
...
### [31] [Exploring Cross-Scenario Generality of Agentic Memory Systems: Diagnostics and a Strong Baseline](https://arxiv.org/abs/2606.04315)
...
### [32] [The Digital Apprentice: A Framework for Human-Directed Agentic AI Development](https://arxiv.org/abs/2606.04321)
...
### [33] [Online Skill Learning for Web Agents via State-Grounded Dynamic Retrieval](https://arxiv.org/abs/2606.04391)
...
### [34] [Not All Errors Are Equal: Consequence-Aware Reasoning Compute Allocation](https://arxiv.org/abs/2606.04402)
...
### [35] [Trivium: Temporal Regret as a First-Class Objective for Causal-Memory Controllers](https://arxiv.org/abs/2606.04421)
*Edward Y. Chang*
...
### [36] [Cascading Hallucination in Agentic RAG: The CHARM Framework for Detection and Mitigation](https://arxiv.org/abs/2606.04435)
*Saroj Mishra*
...
### [37] [The Meta-Agent Challenge: Are Current Agents Capable of Autonomous Agent Development?](https://arxiv.org/abs/2606.04455)
...
### [38] [AgentJet: A Flexible Swarm Training Framework for Agentic Reinforcement Learning](https://arxiv.org/abs/2606.04484)
...
### [39] [Beyond Prompt-Based Planning: MCP-Native Graph Planning-based Biomedical Agent System](https://arxiv.org/abs/2606.04494)
...
### [40] [Simulate, Reason, Decide: Scientific Reasoning with LLMs for Simulation-Driven Decision Making](https://arxiv.org/abs/2606.04505)
...
### [41] [MapAgent: An Industrial-Grade Agentic Framework for City-scale Lane-level Map Generation](https://arxiv.org/abs/2606.04513)
...
### [42] [Scaling Self-Evolving Agents via Parametric Memory](https://arxiv.org/abs/2606.04536)
...
### [45] [Learning Admissible Heuristics via Cost Partitioning](https://arxiv.org/abs/2606.04597)
...
### [46] [Parthenon Law: A Self-Evolving Legal-Agent Framework](https://arxiv.org/abs/2606.04602)
*Hejia Geng,Leo Liu*
...
### [47] [A Normative Intermediate Representation for ASP-Based Compliance Reasoning](https://arxiv.org/abs/2606.04619)
...
### [48] [MIRAGE: Mobile Agents with Implicit Reasoning and Generative World Models](https://arxiv.org/abs/2606.04627)
...
### [49] [BiNSGPS: Geometry Problem Solving via Bidirectional Neuro-Symbolic Interaction](https://arxiv.org/abs/2606.04648)
...
### [50] [Fog of Love: Engineering Virtuous Agent Behavior with Affinity-based Reinforcement Learning in a Game Environment](https://arxiv.org/abs/2606.04750)
...
### [51] [FALSIFYBENCH: Evaluating Inductive Reasoning in LLMs with Rule Discovery Games](https://arxiv.org/abs/2606.04751)
...
### [52] [Inference-Time Vulnerability Beyond Shallow Safety: Alignment Along Generation Trajectories](https://arxiv.org/abs/2606.04778)
...
### [53] [Tree-Based Formalization of Multi-Agent Complementarity in Human-AI Interactions](https://arxiv.org/abs/2606.04779)
*Andrea Ferrario*
...
### [54] [AIP: A Graph Representation for Learning and Governing Agent Skills](https://arxiv.org/abs/2606.04781)
...
### [55] [BiasGRPO: Stabilizing Bias Mitigation in High-Variance Reward Landscapes via Group-Relative Policy Optimization](https://arxiv.org/abs/2606.04807)
...
### [56] [Beyond Objective Equivalence: Constraint Injection for LLM-Based Optimization Modeling on Vehicle Routing Problems](https://arxiv.org/abs/2606.04816)
...
### [57] [R-APS: Compositional Reasoning and In-Context Meta-Learning for Constrained Design via Reflective Adversarial Pareto Search](https://arxiv.org/abs/2606.04823)
...
### [58] [AICompanionBench: Benchmarking LLMs-as-Judges for AI Companion Safety](https://arxiv.org/abs/2606.04867)
...
### [59] [What Type of Inference is Active Inference?](https://arxiv.org/abs/2606.04935)
...
### [60] [Strabo: Declarative Specification and Implementation of Agentic Interaction Protocols](https://arxiv.org/abs/2606.05043)
...
### [61] [AutoLab: Can Frontier Models Solve Long-Horizon Auto Research and Engineering Tasks?](https://arxiv.org/abs/2606.05080)
...
### [62] [Knowledge Index of Noah's Ark](https://arxiv.org/abs/2606.05104)
...
### [63] [MaskForge: Structure-Aware Adaptive Attacks for Jailbreaking Diffusion Large Language Models](https://arxiv.org/abs/2606.04027)
...
### [64] [Need to Know: Contextual-Integrity-Grounded Query Rewriting for Privacy-Conscious LLM Delegation](https://arxiv.org/abs/2606.04067)
...
### [65] [Bayesian Membership Privacy for Graph Neural Networks](https://arxiv.org/abs/2606.04069)
...
### [66] [Covert Influence Between Language Models](https://arxiv.org/abs/2606.04071)
...
### [67] [Caught in the Act(ivation): Toward Pre-Output and Multi-Turn Detection of Credential Exfiltration by LLM Agents](https://arxiv.org/abs/2606.04141)
...
### [68] [MimeLens: Position-Agnostic Content-Type Detection for Binary Fragments](https://arxiv.org/abs/2606.04171)
*Michael J. Bommarito*
...
### [69] [Notarized Agents: Receiver-Attested Confidential Receipts for AI Agent Actions](https://arxiv.org/abs/2606.04193)
*Juan Figuera*
...
### [70] [Long-Term and Short-Term Transistor Aging in Deep Neural Networks: Impact and Mitigation](https://arxiv.org/abs/2606.04266)
...
### [71] [Formal verification of the S-two AIR](https://arxiv.org/abs/2606.04311)
...
### [72] [Toward a Generalized Defense Across Sparse, Continuous, and Structured Parameter Attacks](https://arxiv.org/abs/2606.04317)
...
### [73] [From Untrusted Input to Trusted Memory: A Systematic Study of Memory Poisoning Attacks in LLM Agents](https://arxiv.org/abs/2606.04329)
...
### [74] [TITAN-FedAnil+: Trust-Based Adaptive Blockchain Federated Learning for Resource-Constrained Intelligent Enterprises](https://arxiv.org/abs/2606.04388)
...
### [75] [Pepper: High-bandwidth and Scalable Anonymous Broadcast with Cryptographic Privacy](https://arxiv.org/abs/2606.04411)
...
### [76] [What If Prompt Injection Never Left? Exploring Cross-Session Stored Prompt Injection in Agentic Systems](https://arxiv.org/abs/2606.04425)
...
### [77] [What Can Verifiable Decapsulation Tests Certify? Pass Bounds and Fault-Recognition Limits for FO-Based KEMs](https://arxiv.org/abs/2606.04443)
...
### [78] [Token Rankings are Unforgeable Language Model Signatures](https://arxiv.org/abs/2606.04459)
...
### [79] [CyberGym-E2E: Scalable Real-World Benchmark for AI Agents' End-to-End Cybersecurity Capabilities](https://arxiv.org/abs/2606.04460)
...
### [80] [Global Sketch-Based Watermarking for Diffusion Language Models](https://arxiv.org/abs/2606.04486)
*Daniel Zhao*
...
### [81] [PS-UIE: Privilege-Separated Integrity Enforcement for User-Space Executable Objects in Confidential VMs](https://arxiv.org/abs/2606.04549)
...
### [82] [TIBlender: Early-Warning Threat Intelligence from Cross-Platform Social Media Evidence](https://arxiv.org/abs/2606.04580)
...
### [83] [TeleHunt: A Framework and Tool for Efficient Cybercriminal Community Discovery on Telegram](https://arxiv.org/abs/2606.04657)
...
### [84] [SoK: Post-Quantum Cryptography (PQC) Implementation in Software Systems](https://arxiv.org/abs/2606.04669)
...
### [85] [Selection-Aware Diagnostics for Chain-of-Thought Answer Hijacking](https://arxiv.org/abs/2606.04717)
*Jianwei Tai*
...
### [86] [Description-Code Inconsistency in Real-world MCP Servers: Measurement, Detection, and Security Implications](https://arxiv.org/abs/2606.04769)
...
### [87] [The Usefulness Gap in Proof-of-Useful-Work: An Empirical Study of Pearl's cuPOW Protocol](https://arxiv.org/abs/2606.04819)
*Abhinaba Basu*
...
### [88] [ODYSSEY: Reestablishing Confidentiality in Confidential Blockchain via Delegated Execution](https://arxiv.org/abs/2606.04892)
...
### [89] [DIST-FL: Enhancing Security for TEE-based Aggregation in Federated Learning](https://arxiv.org/abs/2606.04899)
...
### [90] [CLIF: Cross-layer LEO-ISL Fingerprinting for Physical and Network Attack Detection in Dense LEO Constellations](https://arxiv.org/abs/2606.04901)
...
### [91] [TeeDAO: A Decentralized Autonomous Organization for Heterogeneous TEEs](https://arxiv.org/abs/2606.04912)
...
### [92] [NLLog: Lightweight, Explainable SOC Anomaly Detection via Log-to-Language Rewriting](https://arxiv.org/abs/2606.04957)
...
### [93] [From Agent Traces to Trust: Evidence Tracing and Execution Provenance in LLM Agents](https://arxiv.org/abs/2606.04990)
...
### [94] [SharedRequest: Privacy-Preserving Model-Agnostic Inference for Large Language Models](https://arxiv.org/abs/2606.05004)
...
### [95] [Attention-Augmented LSTMs for Automatic Homophonic Ciphertext Decipherment](https://arxiv.org/abs/2606.05078)
...
### [96] [Bernoulli CUSUM and Bayes-Optimal Detection Ceilings for Trust Fraud in Sparse Rating Networks](https://arxiv.org/abs/2606.05090)
*Talal Ashraf Butt*
...
### [97] [A-Live: Passive Liveness Detection via Neuromuscular Micro-Motion Signatures on Commodity Sensors](https://arxiv.org/abs/2606.05126)
...
### [98] [Preserving Data Privacy in Learning Causal Structure with Fully Homomorphic Encryption](https://arxiv.org/abs/2606.05129)
...
### [99] [Polymarket-v1 Database](https://arxiv.org/abs/2606.04217)
*Boka Qin,Rui Yang*
...
### [100] [Dead Science Walking: Publication Bias and the AI Scientist Pipeline](https://arxiv.org/abs/2606.04220)
*Kargi Chauhan*
...
### [101] [When Does Structure Help? The Information Bonus of AlphaFold2 Representations over Protein Language Models](https://arxiv.org/abs/2606.04228)
*Kargi Chauhan*
