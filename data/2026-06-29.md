...
### [1] [Doppler Tracking of the Artemis II Mission (and Other Spacecraft)](https://arxiv.org/abs/2606.27531)
...
### [2] [CryptoGAT: Are Time Series Models Effective for Cryptocurrency Forecasting?](https://arxiv.org/abs/2606.27670)
...
### [3] [Higher-Order Fourier Neural Operator: Explicit Mode Mixer for Nonlinear PDEs](https://arxiv.org/abs/2606.28122)
...
### [4] [When the Aggregator Cheats: Data-Free Backdoors in Federated LLM-based QA Systems](https://arxiv.org/abs/2606.27511)
...
### [5] [On the Inseparability of Instructions and Data in Shared-Embedding Sequence Models](https://arxiv.org/abs/2606.27567)
...
### [6] [AdvScan: Black-Box Adversarial Example Detection at Runtime through Power Analysis](https://arxiv.org/abs/2606.27704)
...
### [7] [Reliable Homomorphic Matching for Fuzzy Labeled PSI at Scale](https://arxiv.org/abs/2606.27803)
*Erkam Uzun*
...
### [8] [Exploring and Exploiting Synchrony Limitations of Time-Triggered Network-Agnostic Guardians](https://arxiv.org/abs/2606.27819)
...
### [9] [Self-Verifying Measurement Records: Hash-Linked Evidence Graphs for Hardware Benchmarking](https://arxiv.org/abs/2606.27934)
...
### [10] [Agentic AI-Powered Re-Identification: An Emerging, Scalable Threat to Mobility Microdata Privacy](https://arxiv.org/abs/2606.27936)
...
### [11] [Decoys Cannot Go Everywhere: Mapping the Deception Surface in MITRE ATT&CK](https://arxiv.org/abs/2606.27966)
...
### [12] [SHARD: cell-keyed residual splitting for alignment-resistant private dense retrieval](https://arxiv.org/abs/2606.27976)
*Sergey Kurilenko*
...
### [13] [AdvancedShelLM: A Stateful Multi-Agent LLM Honeypot for SSH Deception](https://arxiv.org/abs/2606.27990)
...
### [14] [Ghost Without Shell: Measuring Non-Interactive SSH Attacks on Honeypots](https://arxiv.org/abs/2606.28006)
...
### [15] [ToolPrivacyBench: Benchmarking Purpose-Bound Privacy in Tool-Using LLM Agents](https://arxiv.org/abs/2606.28061)
...
### [16] [GTI-mSEMP Framework : A Proposed Framework to Stimulate Malware Propagation with Inclusion of Attacker-Defender Strategy](https://arxiv.org/abs/2606.28079)
...
### [17] [Robust Harmful Features Under Jailbreak Attacks: Mechanistic Evidence from Attention Head Specialization in Large Language Models](https://arxiv.org/abs/2606.28153)
...
### [18] [AI-Model Network: Concept, Current State and Future](https://arxiv.org/abs/2606.27382)
...
### [19] [When Does Personality Composition Matter for Multi-Agent LLM Teams?](https://arxiv.org/abs/2606.27443)
...
### [20] [Internalizing the Future: A Unified Agentic Training Paradigm for World Model Planning](https://arxiv.org/abs/2606.27483)
...
### [22] [Odyssey: Constructing Verifiable Local Truth-Preserving Foundation Models](https://arxiv.org/abs/2606.27593)
*Sridhar Mahadevan*
...
### [23] [DysLexLens: A Low-Resource LLM Framework for Analysing Dyslexic Learners Insights from Online Forums](https://arxiv.org/abs/2606.27619)
...
### [24] [MER-R1: Multimodal Emotion Reasoning via Slow-Fast Thinking Synergy](https://arxiv.org/abs/2606.27652)
...
### [25] [ToE: A Hierarchical and Explainable Claim Verification Framework with Dynamic Multi-source Evidence Retrieval and Aggregation](https://arxiv.org/abs/2606.27736)
...
### [26] [Towards Reliable and Robust LLM Planning: Symbolic Feedback-Driven Iterative Self-Refinement Framework](https://arxiv.org/abs/2606.27757)
...
### [27] [Understanding Rollout Error in Graph World Models](https://arxiv.org/abs/2606.27780)
...
### [28] [Grounded Iterative Language Planning: How Parameterized World Models Reduce Hallucination Propagation in LLM Agents](https://arxiv.org/abs/2606.27806)
*Xinyuan Song,Zekun Cai*
...
### [29] [ATOD: Annealed Turn-aware On-policy Distillation for Multi-turn Autonomous Agents](https://arxiv.org/abs/2606.27814)
...
### [30] [NormAct: A Benchmark for Hidden Social Norm Compliance in Embodied Planning](https://arxiv.org/abs/2606.27826)
...
### [31] [Verifiable Geometry Problem Solving: Solver-Driven Autoformalization and Theorem Proposing](https://arxiv.org/abs/2606.27926)
...
### [32] [RelBall: Relation Ball with Quaternion Rotation for Knowledge Graph Completion](https://arxiv.org/abs/2606.27967)
...
### [33] [Lifted Causal Inference](https://arxiv.org/abs/2606.28024)
...
### [34] [JD Oxygen AI Item Center (Oxygen AIIC) V1: An Industrial-Scale LLM/VLM-Centric Solution for Item Understanding, Management, and Applications](https://arxiv.org/abs/2606.28070)
...
### [35] [Ontology-Guided Evidence Path Inference for Multi-hop Knowledge Graph Question Answering](https://arxiv.org/abs/2606.28076)
...
### [36] [Tandem Reinforcement Learning with Verifiable Rewards](https://arxiv.org/abs/2606.28166)
...
### [37] [Agent-Native Immune System: Architecture, Taxonomy, and Engineering](https://arxiv.org/abs/2606.28270)
...
### [38] [Test-Input Generation for Tensor Programs: What Actually Finds Kernel Bugs](https://arxiv.org/abs/2606.27396)
*Dipankar Sarkar*
...
### [39] [Implementing GenAI-Supported Learning in Software Engineering and Computer Science Education using Bloom's Taxonomy](https://arxiv.org/abs/2606.27398)
...
### [40] [Formal Grammars in Business Process Management: A Systematic Literature Review](https://arxiv.org/abs/2606.27399)
...
### [41] [Recall Before Rerank: Benchmarking Deep Learning Models for Large-Scale Code-to-Code Retrieval](https://arxiv.org/abs/2606.27401)
...
### [42] [Towards Evaluation of Implicit Software World Models in Coding LLMs](https://arxiv.org/abs/2606.27406)
...
### [43] [Speculative Refinement: A Hybrid Autoregressive Diffusion Decoding Strategy and Its Behavior Across Benchmarks](https://arxiv.org/abs/2606.27474)
...
### [44] [Contextual Associations Between Webpage Elements for Web Accessibility: An Empirical Study](https://arxiv.org/abs/2606.27506)
...
### [45] [Test Case Selection for Deep Neural Networks: A Replication Study on LLMs for Code](https://arxiv.org/abs/2606.27601)
...
### [46] [LLM-Assisted Model-Based GUI Testing for Vue.js Web Applications](https://arxiv.org/abs/2606.27665)
...
### [47] [BashCoder-R1: Towards Robust and Explainable Bash Code Generation with Robustness-Aware Group Relative Policy Optimization](https://arxiv.org/abs/2606.27733)
...
### [48] [UNICS: Multilingual Code Search via Unified Pseudocode and Contrastive Transfer Learning](https://arxiv.org/abs/2606.27747)
...
### [49] [Reasoning Beyond Prediction: From Data-Driven to Causal Software Engineering](https://arxiv.org/abs/2606.27960)
...
### [50] [Evolution-Aware Regression Test Prioritization of ML-Enabled Systems Using Gradient-Based Behavior Vectors](https://arxiv.org/abs/2606.28037)
...
### [51] [SBridge: Identifying Source-to-Binary Function Similarity via Cross-Domain Control Block Matching](https://arxiv.org/abs/2606.28058)
...
### [52] [The ARDoCo Tool Landscape: REST API, TraceView, and TraceViz for Architecture Traceability](https://arxiv.org/abs/2606.28064)
...
### [53] [How Humans, Bots, and Agents Communicate About Vulnerabilities in Pull Requests](https://arxiv.org/abs/2606.28125)
...
### [54] [CrossLangFuzzer: Differential Testing of Cross-Language JVM Compilers](https://arxiv.org/abs/2606.28132)
...
### [55] [Humanizing Automatically Generated Unit Test Suites with LLM-Based Refactoring](https://arxiv.org/abs/2606.28229)
...
### [56] [Govern the Repository, Not the Agent: Measuring Ecosystem-Level Risk in AI-Native Software](https://arxiv.org/abs/2606.28235)
*Daniel Russo*
