...
### [9] [EvoTS-Agent: A Self-Evolving LLM Agent for Financial Time Series Change Point Detection](https://arxiv.org/abs/2608.17933)
...
### [10] [KernelArc: A Multi-Agent Framework for GPU Kernel Optimization](https://arxiv.org/abs/2608.17071)
...
### [13] [KnowSim: Evaluating Information Calibration in LLM Assistants with User Simulators that Learn](https://arxiv.org/abs/2608.17150)
...
### [14] [Synthesizing Feature Extractors: An Agentic Approach for Algorithm Selection](https://arxiv.org/abs/2608.17170)
...
### [15] [Benchmarking the Benchmarks: Evaluating Automated Safety Benchmarks for Small Language Models](https://arxiv.org/abs/2608.17183)
...
### [16] [Fool's Gold: Defensive Deception Against Safety-Removal Attacks on Open-Weight Models](https://arxiv.org/abs/2608.17202)
*Mark Russinovich*
...
### [17] [Explicit State Elicitation Is Not Enough: A Controlled Audit of Memory-Policy Classification](https://arxiv.org/abs/2608.17247)
...
### [18] [Do LLMs Know a Good Hypothesis When They See One? Logit-Based Energy Scoring Outperforms Prompted LLM-as-Judge for Scientific Hypothesis Ranking](https://arxiv.org/abs/2608.17270)
...
### [19] [ASI-Bench: At the Dawn of Artificial Superintelligence](https://arxiv.org/abs/2608.17271)
...
### [20] [Agent Lightning v1.0: Towards Harnessed Agentic RL](https://arxiv.org/abs/2608.17528)
...
### [22] [TRUSS: Towards Task-Reliable and User-Safe Automated Agent Skill Generation](https://arxiv.org/abs/2608.17588)
...
### [23] [PlanPO: Group Planning-Aware Policy Optimization for Multi-Turn Agentic LLMs](https://arxiv.org/abs/2608.17289)
...
### [24] [LiveHouse-TS: An Open-world Living Benchmark for Time Series Foundation Models](https://arxiv.org/abs/2608.17299)
...
### [25] [SignalReasoner: Assessing the Upper Bound of 3B Models for Signal Mathematical Reasoning](https://arxiv.org/abs/2608.17301)
*Guozheng Sun*
...
### [26] [Wuying-Browser-Agent: Real-World Centric Fundamental Long-Horizon Browser Agents](https://arxiv.org/abs/2608.17319)
...
### [27] [LLMs for Medical Consultation Are Evaluated Too Late: The Preformulation Gap](https://arxiv.org/abs/2608.17330)
...
### [28] [TileMix: Tile-Centric Mixed-Precision Attention for LLM Inference Acceleration](https://arxiv.org/abs/2608.17336)
...
### [29] [LLM-Only PDDL Domain Repair with Open-Weight Models](https://arxiv.org/abs/2608.17341)
...
### [30] [Cognitive Graph Intelligence for Adaptive and Robust DDoS Attack Detection in Next Generation Networks](https://arxiv.org/abs/2608.17352)
...
### [31] [LEGO-RL: Harness-Native Reinforcement Learning for Coding Agents](https://arxiv.org/abs/2608.17393)
...
### [32] [Task-Aware Harness Provisioning for LLM Agents in Mission-Critical Infrastructure Operations](https://arxiv.org/abs/2608.17433)
...
### [33] [Depth Enables Local Entropy: Quadratic Depth Dependence in Deep Variation-Norm ReLU Regression](https://arxiv.org/abs/2608.17434)
...
### [34] [Structure-Internalized Rule Language Model for Faithful Knowledge Graph Reasoning](https://arxiv.org/abs/2608.17443)
...
### [35] [SAGE: Self-Evolving Storyboard Skills via Attribution-Guided Rule Evolution](https://arxiv.org/abs/2608.17468)
...
### [36] [When AI Designs AI: Innovation or Imitation?](https://arxiv.org/abs/2608.17471)
...
### [37] [Towards Better Agents for Multi-Turn User Interaction: The Next User Turn Is More Than Context](https://arxiv.org/abs/2608.17499)
...
### [38] [SGHA: Evidence-Grounded Research Problem Discovery with Local Language Models](https://arxiv.org/abs/2608.17501)
...
### [39] [When to Review: Spaced Repetition for Continual Pre-Training of Language Models](https://arxiv.org/abs/2608.17530)
...
### [40] [Quantifying Risk Under Evolving Uncertainty: Belief-Dependent Robustness for Safe Sequential Decision Making](https://arxiv.org/abs/2608.17574)
...
### [58] [Adaptive Policy Portfolios for Robust Markov Decision Processes](https://arxiv.org/abs/2608.17929)
...
### [85] [Reduced-Order Physics-Informed Neural Network with Adaptive Basis Refinement for Structural Identification](https://arxiv.org/abs/2608.17131)
...
### [86] [Modeling the Hydrodynamics in the Oslofjord using ADCIRC](https://arxiv.org/abs/2608.17140)
...
### [87] [Information fusion and machine learning for sensitivity analysis using physics knowledge and experimental data](https://arxiv.org/abs/2608.17248)
...
### [88] [Adaptive surrogate modeling for high-dimensional spatio-temporal output](https://arxiv.org/abs/2608.17250)
...
### [89] [A multi-level preprocessing and modelling framework for spectral imaging of microplastics](https://arxiv.org/abs/2608.17697)
...
### [90] [Overlap-free multi-material topology optimization for minimum compliance in two and three dimensions by level-set-based negative-mapping interpolation](https://arxiv.org/abs/2608.17963)
...
### [91] [Quantum-Safe Web Service Architecture Using Time-Based One-Time Passwords](https://arxiv.org/abs/2608.16961)
*Abel C. H. Chen*
...
### [92] [Probing the Prefill: Detecting Code Vulnerabilities via Latent Activations](https://arxiv.org/abs/2608.16970)
*Alizishaan Khatri*
...
### [93] [Remote-Timer-as-a-Service: Efficient Microarchitectural Leakage in the Cloud with Remote Timers](https://arxiv.org/abs/2608.17043)
...
### [94] [CUSTOS: Toward Forensic-Ready Zero Trust at the Capture-Containment Boundary](https://arxiv.org/abs/2608.17068)
...
### [95] [SentryBus: A Multi-Vantage Observability Model and Validated Instrument for I2C Sensor-Interface Manipulation](https://arxiv.org/abs/2608.17082)
...
### [96] [Structured Driving-State Narratives for Small Language Model-Based GNSS Spoofing Detection](https://arxiv.org/abs/2608.17092)
...
### [97] [Digital Twin-Based Intrusion Detection for Vehicle Powertrain CAN Bus Systems](https://arxiv.org/abs/2608.17093)
...
### [98] [Protocol-Embedded Compliance for Privacy-Preserving, Non-Custodial Digital Payments](https://arxiv.org/abs/2608.17145)
...
### [99] [Picture the Epsilon: Pursuing Identity-Level Privacy Guarantees for Images](https://arxiv.org/abs/2608.17147)
...
### [100] [Authorization Before Context: A Model-Neutral Audience Boundary Against Cross-Audience Memory Leakage in Agentic Systems](https://arxiv.org/abs/2608.17148)
*Sibo Liu*
...
### [101] [Beyond the Hype: Evaluating LLM Integration and Practical Limitations in Security Operation Centers](https://arxiv.org/abs/2608.17154)
...
### [103] [The Acknowledgment Point Is the System: Durable Policy-Decision Receipts for AI Audit Evidence](https://arxiv.org/abs/2608.17176)
...
### [104] [PACE: Policy-Attested Contract Execution for Safe AI Agents in Decentralized Finance](https://arxiv.org/abs/2608.17220)
...
### [105] [COMIC: Reference-Aware Safety Gating for Multimodal Large Language Models](https://arxiv.org/abs/2608.17234)
...
### [106] [ADAPTD: Adaptive Detection and Proactive Threat Defense for Autonomous APT attacks](https://arxiv.org/abs/2608.17251)
...
### [107] [When Agents Act on Web3: An Attack-Surface Survey of MCP, Skills, and Tool Calling](https://arxiv.org/abs/2608.17275)
...
### [108] [Fair ASR: Re-Evaluating Black-Box Jailbreaks under Shared Target-Call Budgets](https://arxiv.org/abs/2608.17360)
...
### [109] [Trusted Workflow Relays:Cross-Tenant Email Abuse and Composable Red Team Initial-Access Primitives in Multi-Tenant Clouds](https://arxiv.org/abs/2608.17361)
*Priyank Nigam*
...
### [110] [FESC: Remodeling Long-Context Private Inference with Encrypted State-Space Models](https://arxiv.org/abs/2608.17442)
...
### [111] [Decomposition Attacks Across Unlinkable Identities: Limits of Stateful Defenses for LLM Services](https://arxiv.org/abs/2608.17445)
...
### [112] [KeyPooling: Measuring Where LLM API Relay Paths Collapse Prompt Cache Isolation](https://arxiv.org/abs/2608.17485)
...
### [113] [Cross-Domain Joint DDoS Detection in Multi-Controller SDN via Confidence-Based Entropy Fusion](https://arxiv.org/abs/2608.17507)
...
### [114] [CryptDough: A Unified Analytics Engine for Secure Multiparty Computation](https://arxiv.org/abs/2608.17529)
...
### [115] [SoK: Cross-Chain Transaction Identification and Matching](https://arxiv.org/abs/2608.17532)
...
### [116] [TENET: Telegram Mini App (in)security](https://arxiv.org/abs/2608.17538)
...
### [117] [Software Defined Networks Key Relay for Large-Scale Quantum Key Distribution Networks](https://arxiv.org/abs/2608.17539)
...
### [118] [Reflex-Guard: A Low-Latency Guardrail for LLM Prompt Safety Using Dense Semantic Embeddings](https://arxiv.org/abs/2608.17556)
...
### [119] [HarnessRisk: A Lifecycle-Oriented Benchmark for Agent Harness Safety](https://arxiv.org/abs/2608.17597)
...
### [120] [An Emulation Anchored Digital Twin Testbed for Cyberattack and Defense Analysis in Hospital IT OT Environments](https://arxiv.org/abs/2608.17650)
...
### [121] [MobileWorldSafety: Benchmarking GUI Agent Safety Against Environmental Injection Attacks in Android Apps](https://arxiv.org/abs/2608.17659)
...
### [122] [MemCatalyst: Amplifying Data Auditing on Vision-Language Models via Data Poisoning](https://arxiv.org/abs/2608.17722)
...
### [123] [BullsEye: Directed Firmware Fuzzing](https://arxiv.org/abs/2608.17729)
...
### [124] [Achievement Unlocked: Let's Get Hacked! An Empirical Study of Cybercrime in the Video Gaming Ecosystem](https://arxiv.org/abs/2608.17754)
...
### [125] [Efficient Fuzzy PSI under One-Sided Assumptions](https://arxiv.org/abs/2608.17770)
...
### [126] [Diff-DDoS: Realistic Cyber-Physical Attack Synthesis and Robust Detection for 5G-Enabled CPS Using Tabular Diffusion Models](https://arxiv.org/abs/2608.17796)
...
### [127] [The Model's Tell: Measuring Context-Leakage Attack Signals with Behavior Gauges](https://arxiv.org/abs/2608.17829)
...
### [128] [COMA: A Compositional Misleading Attack Class on Security-RAG, and a Causal Counterfactual Defense](https://arxiv.org/abs/2608.17960)
