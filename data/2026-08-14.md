...
### [8] [Don't Want Your LLM to Recommend Nuclear Strike? Try Asking It in Japanese](https://arxiv.org/abs/2608.12373)
*Rian Touchent*
...
### [9] [Dual-Flow Transformers: Decoupling the Primary Prefill Path from Additional Decode Computation](https://arxiv.org/abs/2608.12385)
...
### [10] [Learning to Adapt Cross-Domain Preferences via Meta-LoRA for LLM Personalization](https://arxiv.org/abs/2608.12389)
...
### [11] [Research Assistant: AstraZeneca's Agentic System for R&D](https://arxiv.org/abs/2608.12395)
...
### [12] [Large Language Models Can Follow Instructions, But Not Many at Once: Phase Transitions in Compositional Constraint Satisfaction](https://arxiv.org/abs/2608.12426)
*Mariya I. Vasileva*
...
### [13] [QuoteBench: How Matched Scores Can Hide Command-Path Failures](https://arxiv.org/abs/2608.13547)
...
### [25] [Privacy-Preserving RAG by Concealing Sensitive Information from External LLMs](https://arxiv.org/abs/2608.12675)
...
### [30] [Sovereign by necessity? Frontier AI export controls, cyber security, and the limits of national AI capability](https://arxiv.org/abs/2608.13272)
...
### [33] [Lines and Ladders: A Context-Aware Multi-Agent Framework for Large-Scale Retail Price Taxonomy](https://arxiv.org/abs/2608.12674)
...
### [36] [Spatial Memory Agent: Experience-Grounded Procedure Memory for Spatial Intelligence](https://arxiv.org/abs/2608.12743)
...
### [45] [Agent Behavioral Contracts II: Certifying Compositional Reliability Without Assuming Independence](https://arxiv.org/abs/2608.12895)
...
### [46] [Polish Medical Visual Question Answering: Vision-Language Models Underutilize Visual Evidence](https://arxiv.org/abs/2608.12928)
...
### [47] [FlashDrive: Flash Vision-Language-Action Inference for Autonomous Driving](https://arxiv.org/abs/2608.12932)
...
### [48] [Decomposition of Evidence, Contradiction, and Fragility in Perturbation Responses](https://arxiv.org/abs/2608.12935)
*Lei You*
...
### [49] [Moose: Latent concept learning with reasoning-shortcut awareness in $\mathcal{EL}^{++}$](https://arxiv.org/abs/2608.12961)
...
### [50] [OGR-MARL: Option-Guided Residual Multi-Agent Reinforcement Learning for Heterogeneous USV Cooperative Pursuit in Constrained Port Waterways](https://arxiv.org/abs/2608.12995)
...
### [51] [Foundations of MT-PDCL: Measure-Theoretic Probabilistic Definite Clause Logic](https://arxiv.org/abs/2608.13018)
...
### [52] [From Local Mismatch to Global Impact: Optimizing Cache Reuse Policy for Efficient Diffusion](https://arxiv.org/abs/2608.13043)
...
### [86] [ARIES-Mission2: A Zero-Shot Vision-Language-Action Framework for Fast Large-Scale Aerial Mission Generation](https://arxiv.org/abs/2608.12763)
...
### [87] [Julia for CFD: A Critical Survey of Ecosystem, Performance, and Composability](https://arxiv.org/abs/2608.12801)
*Tianbai Xiao*
...
### [88] [Spinal Coupling in Frontal and Transversal Plane During Gait - A Segmental and Time-Dependent Analysis of the Thoracic and Lumbar Spine](https://arxiv.org/abs/2608.12945)
...
### [89] [TIEM: Temporal Integration of Hypergraph Evidence and Skill Memory for Event-Driven Financial Forecasting](https://arxiv.org/abs/2608.13024)
...
### [90] [SynWeaver: Website-Prior Task and Trajectory Co-Synthesis for Web Agents](https://arxiv.org/abs/2608.12429)
...
### [91] [Specification-first convergence with an AI coding agent: a case study of dismantling a core architectural invariant across 189 files in a 717k-line codebase with no test oracle and no human code review](https://arxiv.org/abs/2608.12440)
*Joel Abenhaim*
...
### [92] [Does It Render Everywhere? A Study of Cross-Environment Compatibility in MLLM-Generated Webpages](https://arxiv.org/abs/2608.12518)
...
### [93] [Memorization Diagnostics for Code LLMs Should be Scale-Aware](https://arxiv.org/abs/2608.12771)
...
### [94] [Dissecting Software Graphs: Structural Insights for Driver-Guided Fuzzing](https://arxiv.org/abs/2608.12859)
...
### [95] [Requirements-Augmented Generation for Trustworthy Acceptance Testing of LLM-Based Software](https://arxiv.org/abs/2608.12970)
...
### [96] [How Powerful are LLMs in Generating Formal Program Specifications?](https://arxiv.org/abs/2608.13077)
...
### [97] [Can Formal Specifications Be Synthesized from Tests Alone?](https://arxiv.org/abs/2608.13240)
...
### [98] [Refine After Generation: Toward Correct and Concise Patches in LLM-based Program Repair](https://arxiv.org/abs/2608.13292)
...
### [99] [Integration-First Structural Coverage for Embedded Software:Trace-Based Evidence, Hybrid Runtime Analysis, and Cross-Variant Consolidation](https://arxiv.org/abs/2608.13322)
...
### [100] [Does Fixing Break Security? An Empirical Study of Security Degradation in Iterative LLM-Driven Infrastructure-as-Code Repair](https://arxiv.org/abs/2608.13404)
...
### [101] [LLM-Assisted Dynamic Threat Analysis for Attacker-Reachable Software Weaknesses in Autonomous Vehicles](https://arxiv.org/abs/2608.13450)
...
### [102] [CAPRI: Contract-Aware Proof Repair for Isabelle](https://arxiv.org/abs/2608.13459)
...
### [103] [DCBA: Detection of Collaborative Black-Hole Attacks in Connected Dominated Set using Baiting Process](https://arxiv.org/abs/2608.12347)
...
### [104] [The energetic cost of mitigating AI attacks in cellular networks](https://arxiv.org/abs/2608.12431)
...
### [105] [Non-Degenerate Risk Certification for Automated Security Decisions: A Decision-Contract Theory with ATT\&CK-Aligned Triage as a Worked Instance](https://arxiv.org/abs/2608.12444)
*Zhenpeng Li*
...
### [106] [SoK: From Generation to Consumption of Privacy Documents in Software Systems](https://arxiv.org/abs/2608.12511)
...
### [107] [Tracing Provenance and Detecting Tampering with Complementary LLM Watermarks](https://arxiv.org/abs/2608.12713)
...
### [108] [PIPES: Securing Agent Perception with Provenance and Priors](https://arxiv.org/abs/2608.12789)
...
### [109] [RealmEye: Virtual Machine Introspection for Arm CCA Realm VMs](https://arxiv.org/abs/2608.12822)
...
### [110] [Beyond Source: An Empirical Study of Python Bytecode Security Risks](https://arxiv.org/abs/2608.12853)
...
### [111] [Discovering Persistent Behavioural Patterns for Interpretable Blockchain Forensics](https://arxiv.org/abs/2608.12864)
...
### [112] [Labels Are Not Endpoints: Treatment Leakage and Construct Validity in MCP Agent Security Evaluation](https://arxiv.org/abs/2608.12880)
...
### [113] [Smart Contract Invariants Protect Against Cybercriminals](https://arxiv.org/abs/2608.13191)
...
### [114] [Adversarial Robustness in Smishing Detection: A Comparative Analysis of Adversarial Fragility in Classical vs. Transformer-Based Detection Systems](https://arxiv.org/abs/2608.12889)
...
### [115] [Beyond Handcrafted Security: Towards Self-Evolving Defense for LLM Agents](https://arxiv.org/abs/2608.12977)
...
### [116] [ATOBench: Tracing How Autonomous Penetration-Testing Agents Verify Vulnerabilities When Target Evidence Lies](https://arxiv.org/abs/2608.12996)
...
### [117] [OmniSphinx: Active Mix Networks (Extended Version)](https://arxiv.org/abs/2608.13008)
...
### [118] [InterSAGE: The Secure and Verifiable Interoperability Protocol for An Internet of Agents](https://arxiv.org/abs/2608.13030)
...
### [119] [InSPECtor: Improving SLEIGH Processor Specification Veracity via Proxy](https://arxiv.org/abs/2608.13042)
...
### [120] [Operationalizing Cyber Threat Intelligence with GraphRAG](https://arxiv.org/abs/2608.13050)
...
### [121] [A Commitment-Based Hybrid Post-Quantum Cryptographic Model for Multi-File Cloud Storage](https://arxiv.org/abs/2608.13138)
...
### [122] [Slow and Steady: Preventing MEV with Verifiable Delays](https://arxiv.org/abs/2608.13271)
...
### [123] [VR-Themis: A Scalable Framework for Virtual Reality Application Clone Detection](https://arxiv.org/abs/2608.13290)
...
### [124] [TeleGapper: On the (un)reliability of Privacy Policies in Telegram Mini apps](https://arxiv.org/abs/2608.13390)
