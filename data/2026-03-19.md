...
### [8] [Generative AI-assisted Participatory Modeling in Socio-Environmental Planning under Deep Uncertainty](https://arxiv.org/abs/2603.17021)
...
### [9] [Transformers are Bayesian Networks](https://arxiv.org/abs/2603.17063)
*Gregory Coppola*
...
### [10] [Cascade-Aware Multi-Agent Routing: Spatio-Temporal Sidecars and Geometry-Switching](https://arxiv.org/abs/2603.17112)
*Davide Di Gioia*
...
### [11] [How Clued up are LLMs? Evaluating Multi-Step Deductive Reasoning in a Text-Based Game Environment](https://arxiv.org/abs/2603.17169)
...
### [12] [AI Scientist via Synthetic Task Scaling](https://arxiv.org/abs/2603.17216)
...
### [14] [Graph-Native Cognitive Memory for AI Agents: Formal Belief Revision Semantics for Versioned Memory Architectures](https://arxiv.org/abs/2603.17244)
*Young Bin Park*
...
### [15] [Contrastive Reasoning Alignment: Reinforcement Learning from Hidden Representations](https://arxiv.org/abs/2603.17305)
...
### [16] [InfoDensity: Rewarding Information-Dense Traces for Efficient Reasoning](https://arxiv.org/abs/2603.17310)
...
### [17] [Physics-informed offline reinforcement learning eliminates catastrophic fuel waste in maritime routing](https://arxiv.org/abs/2603.17319)
...
### [19] [A Progressive Visual-Logic-Aligned Framework for Ride-Hailing Adjudication](https://arxiv.org/abs/2603.17328)
...
### [22] [Proactive Knowledge Inquiry in Doctor-Patient Dialogue: Stateful Extraction, Belief Updating, and Path-Aware Action Planning](https://arxiv.org/abs/2603.17425)
...
### [23] [When Only the Final Text Survives: Implicit Execution Tracing for Multi-Agent Attribution](https://arxiv.org/abs/2603.17445)
...
### [24] [Informative Semi-Factuals for XAI: The Elaborated Explanations that People Prefer](https://arxiv.org/abs/2603.17534)
...
### [25] [Per-Domain Generalizing Policies: On Learning Efficient and Robust Q-Value Functions (Extended Version with Technical Appendix)](https://arxiv.org/abs/2603.17544)
...
### [26] [VeriGrey: Greybox Agent Validation](https://arxiv.org/abs/2603.17639)
...
### [27] [Sensi: Learn One Thing at a Time -- Curriculum-Based Test-Time Learning for LLM Game Agents](https://arxiv.org/abs/2603.17683)
*Mohsen Arjmandi*
...
### [28] [MALLES: A Multi-agent LLMs-based Economic Sandbox with Consumer Preference Alignment](https://arxiv.org/abs/2603.17694)
...
### [29] [From Virtual Environments to Real-World Trials: Emerging Trends in Autonomous Driving](https://arxiv.org/abs/2603.17714)
...
### [30] [Facts as First Class Objects: Knowledge Objects for Persistent LLM Memory](https://arxiv.org/abs/2603.17781)
...
### [31] [Governed Memory: A Production Architecture for Multi-Agent Workflows](https://arxiv.org/abs/2603.17787)
*Hamed Taheri*
...
### [32] [RPMS: Enhancing LLM-Based Embodied Planning through Rule-Augmented Memory Synergy](https://arxiv.org/abs/2603.17831)
...
### [33] [AgentFactory: A Self-Evolving Framework Through Executable Subagent Accumulation and Reuse](https://arxiv.org/abs/2603.18000)
...
### [34] [The State of Generative AI in Software Development: Insights from Literature and a Developer Survey](https://arxiv.org/abs/2603.16975)
...
### [35] [When the Specification Emerges: Benchmarking Faithfulness Loss in Long-Horizon Coding Agents](https://arxiv.org/abs/2603.17104)
...
### [36] [A Longitudinal Study of Usability in Identity-Based Software Signing](https://arxiv.org/abs/2603.17133)
...
### [37] [Intent Formalization: A Grand Challenge for Reliable Coding in the Age of AI Agents](https://arxiv.org/abs/2603.17150)
*Shuvendu K. Lahiri*
...
### [38] [Energy Flow Graph: Modeling Software Energy Consumption](https://arxiv.org/abs/2603.17162)
...
### [39] [Talk is Cheap, Logic is Hard: Benchmarking LLMs on Post-Condition Formalization](https://arxiv.org/abs/2603.17193)
...
### [40] [Revisiting Vulnerability Patch Identification on Data in the Wild](https://arxiv.org/abs/2603.17266)
...
### [41] [MLmisFinder: A Specification and Detection Approach of Machine Learning Service Misuses](https://arxiv.org/abs/2603.17330)
...
### [42] [Bootstrapping Coding Agents: The Specification Is the Program](https://arxiv.org/abs/2603.17399)
*Martin Monperrus*
...
### [43] [Requirements Volatility in Software Architecture Design: An Exploratory Case Study](https://arxiv.org/abs/2603.17648)
...
### [44] [From Symbol to Meaning: Ontological and Philosophical Reflections on Large Language Models in Information Systems Engineering](https://arxiv.org/abs/2603.17659)
...
### [45] [CodeT5-RNN: Reinforcing Contextual Embeddings for Enhanced Code Comprehension](https://arxiv.org/abs/2603.17821)
...
### [46] [FailureMem: A Failure-Aware Multimodal Framework for Autonomous Software Repair](https://arxiv.org/abs/2603.17826)
...
### [47] [CodeScout: An Effective Recipe for Reinforcement Learning of Code Search Agents](https://arxiv.org/abs/2603.17829)
...
### [48] [ArchBench: Benchmarking Generative-AI for Software Architecture Tasks](https://arxiv.org/abs/2603.17833)
...
### [49] [scicode-lint: Detecting Methodology Bugs in Scientific Python Code with LLM-Generated Patterns](https://arxiv.org/abs/2603.17893)
*Sergey V. Samsonau*
...
### [50] [In Perfect Harmony: Orchestrating Causality in Actor-Based Systems](https://arxiv.org/abs/2603.17909)
...
### [51] [CodeGreen: Towards Improving Precision and Portability in Software Energy Measurement](https://arxiv.org/abs/2603.17924)
*Saurabhsingh Rajput,Tushar Sharma*
...
### [52] [TDAD: Test-Driven Agentic Development - Reducing Code Regressions in AI Coding Agents via Graph-Based Impact Analysis](https://arxiv.org/abs/2603.17973)
*Pepe Alonso*
...
### [53] [Toward Scalable Automated Repository-Level Datasets for Software Vulnerability Detection](https://arxiv.org/abs/2603.17974)
*Amine Lbath*
...
### [54] [Noticing the Watcher: LLM Agents Can Infer CoT Monitoring from Blocking Feedback](https://arxiv.org/abs/2603.16928)
...
### [55] [Cryptographic Runtime Governance for Autonomous AI Systems: The Aegis Architecture for Verifiable Policy Enforcement](https://arxiv.org/abs/2603.16938)
...
### [56] [Adversarial attacks against Modern Vision-Language Models](https://arxiv.org/abs/2603.16960)
...
### [57] [DeepStage: Learning Autonomous Defense Policies Against Multi-Stage APT Campaigns](https://arxiv.org/abs/2603.16969)
...
### [58] [An End-to-End Framework for Functionality-Embedded Provenance Graph Construction and Threat Interpretation](https://arxiv.org/abs/2603.17100)
...
### [59] [Security Assessment and Mitigation Strategies for Large Language Models: A Comprehensive Defensive Framework](https://arxiv.org/abs/2603.17123)
...
### [60] [Synchronized DNA sources for unconditionally secure cryptography](https://arxiv.org/abs/2603.17149)
...
### [61] [PAuth - Precise Task-Scoped Authorization For Agents](https://arxiv.org/abs/2603.17170)
...
### [62] [Detecting Data Poisoning in Code Generation LLMs via Black-Box, Vulnerability-Oriented Scanning](https://arxiv.org/abs/2603.17174)
...
### [63] [Towards Unsupervised Adversarial Document Detection in Retrieval Augmented Generation Systems](https://arxiv.org/abs/2603.17176)
*Patrick Levi*
...
### [64] [LAAF: Logic-layer Automated Attack Framework A Systematic Red-Teaming Methodology for LPCI Vulnerabilities in Agentic Large Language Model Systems](https://arxiv.org/abs/2603.17239)
...
### [65] [Deanonymizing Bitcoin Transactions via Network Traffic Analysis with Semi-supervised Learning](https://arxiv.org/abs/2603.17261)
...
### [66] [Network- and Device-Level Cyber Deception for Contested Environments Using RL and LLMs](https://arxiv.org/abs/2603.17272)
...
### [67] [SEAL-Tag: Self-Tag Evidence Aggregation with Probabilistic Circuits for PII-Safe Retrieval-Augmented Generation](https://arxiv.org/abs/2603.17292)
...
### [68] [Federated Computing as Code (FCaC): Sovereignty-aware Systems by Design](https://arxiv.org/abs/2603.17331)
...
### [69] [WebPII: Benchmarking Visual PII Detection for Computer-Use Agents](https://arxiv.org/abs/2603.17357)
*Nathan Zhao*
...
### [70] [Caging the Agents: A Zero Trust Security Architecture for Autonomous AI in Healthcare](https://arxiv.org/abs/2603.17419)
*Saikat Maiti*
...
### [71] [DDH-based schemes for multi-party Function Secret Sharing](https://arxiv.org/abs/2603.17453)
...
### [72] [Proof-of-Authorship for Diffusion-based AI Generated Content](https://arxiv.org/abs/2603.17513)
...
### [73] [Post-Training Local LLM Agents for Linux Privilege Escalation with Verifiable Rewards](https://arxiv.org/abs/2603.17673)
...
### [74] [Machine Learning for Network Attacks Classification and Statistical Evaluation of Machine Learning for Network Attacks Classification and Adversarial Learning Methodologies for Synthetic Data Generation](https://arxiv.org/abs/2603.17717)
...
### [75] [Data Obfuscation for Secure Use of Classical Values in Quantum Computation](https://arxiv.org/abs/2603.17725)
...
### [76] [SoK: From Silicon to Netlist and Beyond $-$ Two Decades of Hardware Reverse Engineering Research](https://arxiv.org/abs/2603.17883)
...
### [77] [Differential Privacy in Generative AI Agents: Analysis and Optimal Tradeoffs](https://arxiv.org/abs/2603.17902)
