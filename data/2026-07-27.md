...
### [44] [What AI Red-Team Evaluations Can and Cannot Prove](https://arxiv.org/abs/2607.21735)
*Bandana Kaur*
...
### [45] [Trajectory-Aware Retrieval Agents for Temporal Decision- Making](https://arxiv.org/abs/2607.21625)
...
### [46] [Discrete Action Space as a Prerequisite for GRPO Convergence in Small-Model Continuous Control](https://arxiv.org/abs/2607.21626)
...
### [47] [Do Modules Stay in Their Lane? Role Drift in Compound LLM Systems](https://arxiv.org/abs/2607.21627)
...
### [48] [Wavelet Phase Diffusion for Structurally and Semantically Consistent Sim-to-Real Translation](https://arxiv.org/abs/2607.21628)
...
### [49] [Defining AI-Native Systems: Autonomy as Revision Authority](https://arxiv.org/abs/2607.21659)
*Cheng Tan*
...
### [50] [Dynamic Capability Scoping for Enterprise AI Agents: A Synthetic Dataset and Three-Source Permission Architecture](https://arxiv.org/abs/2607.22445)
*Halil Burak Noyan*
...
### [51] [Persistent Computational State: A Session-Centric Runtime for Generative World Models](https://arxiv.org/abs/2607.21686)
*Zhen Lin*
...
### [52] [From Seasonality to Semantics: Benchmarking a Hybrid Probabilistic Forecasting System for Roadblocks in Bolivia](https://arxiv.org/abs/2607.21785)
...
### [53] [QLPO: Quadrant-weighted Sampling for Length-aware Policy Optimization](https://arxiv.org/abs/2607.21793)
...
### [54] [DAGForge: Auditable Causal DAG Authoring with Biomedical Literature](https://arxiv.org/abs/2607.21859)
...
### [55] [When Is a Learned Command Adapter Worth It? Closed-Loop Identification and Counterfactual Auditing of Frozen Locomotion Policies](https://arxiv.org/abs/2607.21867)
*Zongtan Li*
...
### [56] [Multi-Agent System-driven Digital Twins for predictive maintenance: architectures, technologies and open research challenges](https://arxiv.org/abs/2607.21873)
...
### [57] [TRW: TRACE-RealWorld---An Auditable Consistency Contract for World Models as Materialized Views](https://arxiv.org/abs/2607.21910)
*Edward Y. Chang*
...
### [58] [Semiotic logical hexagon theory for LLM logical reasoning](https://arxiv.org/abs/2607.21933)
...
### [59] [Learning as Reasoning Unfolds: Progressive Rollout Allocation for Efficient Reinforcement Learning](https://arxiv.org/abs/2607.22002)
...
### [60] [Zero-Shot Mission-Level Evaluation for Aerial MLLM Agents](https://arxiv.org/abs/2607.22014)
...
### [62] [Reasoning Denoiser: Denoising Reasoning Traces for Hallucination Detection in Large Reasoning Models](https://arxiv.org/abs/2607.22098)
...
### [63] [Industrial Tokenization for LLM-Based Health Intelligence: A Federated Architecture for Industrial Evidence Integration](https://arxiv.org/abs/2607.22153)
...
### [64] [Learning on the Job: Continual Learning from Deployment Feedback for Frozen-Weights Agents](https://arxiv.org/abs/2607.22157)
...
### [65] [Deconstructing Off-Policy Ratios: Entropy-Scaled Trust Regions for Asynchronous Reinforcement Learning](https://arxiv.org/abs/2607.22186)
...
### [66] [AI4PLE: A Methodology for Integrating AI into Product Line Engineering](https://arxiv.org/abs/2607.22260)
*Bedir Tekinerdogan*
...
### [67] [A Roadmap to Impactful Pluralistic Alignment Research](https://arxiv.org/abs/2607.22305)
...
### [68] [Learning Structural Convergence: A Neuro-Symbolic Benchmark for Temporal Reasoning](https://arxiv.org/abs/2607.22365)
...
### [69] [Do Agent Benchmarks Measure Capability? Protocol Validity in the Age of Agentic AI](https://arxiv.org/abs/2607.22368)
...
### [70] [IDEAgent: Agentic Quality-Diversity Search for Research Idea Generation](https://arxiv.org/abs/2607.22375)
...
### [71] [Agentic Root Cause Analysis through Evidence-Grounded Reasoning](https://arxiv.org/abs/2607.22385)
...
### [72] [SceneActBench: Can Agents Act on the 3D Scenes They See?](https://arxiv.org/abs/2607.22393)
...
### [76] [Learning Population-Level Dynamics through a Latent Fokker--Planck Model and Discrepancy Transport Maps](https://arxiv.org/abs/2607.21921)
...
### [77] [Generalized Neural Operator for Parametric and Boundary-Value Problems](https://arxiv.org/abs/2607.21932)
...
### [78] [Efficient Spatial-Spectral Feature Extraction in Hyperspectral Images via Holistic Multivariance Decomposition](https://arxiv.org/abs/2607.22272)
*Süha Tuna*
...
### [79] [On the alleged chaos in periodically forced traveling-wave reductions of fractional WBBM models: a quantitative re-examination](https://arxiv.org/abs/2607.22475)
*Kaixuan Niu*
...
### [80] [CARE: Pre-Execution Command Verification for Shell-Executing LLM Agents](https://arxiv.org/abs/2607.21642)
...
### [81] [StajChain: A Hyperledger Fabric-Based Multi-Party Internship Agreement System](https://arxiv.org/abs/2607.21643)
*Rampia Perente*
...
### [82] [A method of Risk Analysis and threat management using analytic hierarchy process](https://arxiv.org/abs/2607.21691)
...
### [83] [Every Model Cheats: Prompt-Level Mitigation of Cheating on Offensive Cyber Tasks](https://arxiv.org/abs/2607.21763)
...
### [84] [Adversarial Prompts for Acceptance Collapse in Speculative Decoding](https://arxiv.org/abs/2607.21804)
...
### [85] [Protocol-Level Attacks on Agentic Commerce Platforms: A Cross-Platform Taxonomy, AIP-Bench, and Unified Defense](https://arxiv.org/abs/2607.21824)
*Yedidel Louck*
...
### [86] [ToolGuardian: Declarative Security for AI Agent-Tool Interactions](https://arxiv.org/abs/2607.21835)
...
### [87] [Certified in Theory, Broken in Practice: Assumption Gaps in Cryptographic Model Certification](https://arxiv.org/abs/2607.21839)
...
### [88] [Decentralized Compute on Untrusted Hardware Using Intel TDX and Encrypted CVMs](https://arxiv.org/abs/2607.21865)
...
### [89] [PrivDNN: A Secure Multi-Party Computation Framework for Deep Learning using Partial DNN Encryption](https://arxiv.org/abs/2607.21895)
...
### [90] [Cleaning the NTP Pool: Detecting and Mitigating NTP-Sourced IPv6 Scanning](https://arxiv.org/abs/2607.21903)
...
### [91] [Incentives and Market Structure in Intent-Based Exchanges: Evidence from a Solver-Reward Reform](https://arxiv.org/abs/2607.21955)
*Ruiyang Zhang*
...
### [92] [Ethereum NFT Smart Contracts: Knowledge-Guided Vulnerability Detection with LLM and Code Slicing](https://arxiv.org/abs/2607.21983)
...
### [93] [Practical Graph Optimisation and AI-Driven Models for Active Directory Security Hardening](https://arxiv.org/abs/2607.22009)
*Huy Q. Ngo*
...
### [94] [Agent Security Needs Redefinition through a Holistic Framework](https://arxiv.org/abs/2607.22024)
...
### [95] [BioZKFHE: Scalable Encrypted Biometric Identification via Verifiable Homomorphic Similarity Evaluation](https://arxiv.org/abs/2607.22065)
...
### [96] [PoCEvolve: Generating Proof-of-Concept Exploits from Security Patches with Vulnerability-Aware Prompt Evolution](https://arxiv.org/abs/2607.22076)
...
### [97] [Transforming Keystroke Noise to Text: Self-Supervised Acoustic Eavesdropping Attacks on Keyboards](https://arxiv.org/abs/2607.22094)
...
### [98] [DeFiScreener: Efficient DeFi Attack Pre-screening in Smart Contracts via Historical Case Matching](https://arxiv.org/abs/2607.22184)
...
### [99] [trasgoDP: An Open Source Framework for Releasing Noised Tabular Microdata under Local Differential Privacy](https://arxiv.org/abs/2607.22230)
...
### [100] [Kalyna Block Cipher: From Design Space Exploration to ASIC Design](https://arxiv.org/abs/2607.22269)
...
### [101] [A Maximum Entropy Implementation of Differential Privacy Under Linear Invariants](https://arxiv.org/abs/2607.22450)
...
### [102] [Broken Object Level Authorization in the Wild: An Empirical Taxonomy from 100+ Bug Bounty Disclosures](https://arxiv.org/abs/2605.25865)
*Bandana Kaur*
